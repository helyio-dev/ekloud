...
export default function WeeklyPage() {
    ...
    return (
        <div className="min-h-screen bg-background text-text font-sans relative overflow-hidden">
            <div className="absolute top-0 right-0 w-[40vw] h-[40vw] rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none opacity-20"
            ...
            <div className="max-w-3xl mx-auto px-6 py-10 relative z-10">
                ...
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-black uppercase tracking-tighter">Quiz Hebdomadaire</h1>
                        <p className={`text-sm font-bold ${conf.color}`}>{clan} · Une participation par semaine</p>
                    </div>
                </div>

                {/* Composant quiz — forcé sur l'onglet semaine uniquement */}
                <WeeklyCompetition userClan={clan as SquadId} defaultTab="week" />
            </div>
        </div>
    );
}
