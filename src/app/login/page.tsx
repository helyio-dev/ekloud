        ...
        <div className="min-h-screen flex items-center justify-center p-6 bg-background">
            <div className="w-full max-w-md bg-surface border border-border rounded-2xl p-8 shadow-2xl">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-center tracking-tight">Ekloud</h1>
                    <p className="text-text-muted text-sm text-center mt-3 max-w-[280px]">
                        Rejoins l'écosystème pour propulser tes compétences technologiques.
                    </p>
                </div>

                {/* boutons de connexion via les fournisseurs oauth */}
                ...
                <div className="mt-12 text-center">
                    <p className="text-[11px] text-text-muted">
                        Plateforme d'apprentissage technologique propulsée par la communauté.
                    </p>
                </div>
            </div>
        </div>
